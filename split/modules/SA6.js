...
var SA6 = v(QV3 => {
  ...
  class Y64 {
    ...
    constructor({
      name: A,
      kind: K = uV3.FieldPosition.HEADER,
      values: q = []
    }) {
  ...
  class t41 {
    ...
    static clone(A) {
      ...
      if (K.query) K.query = gV3(K.query);
      return K;
    }
    static isInstance(A) {
      if (!A) return !1;
  ...
  QV3.Fields = z64;
  QV3.HttpRequest = t41;
  QV3.HttpResponse = w64;
  QV3.getHttpHandlerExtensionConfiguration = BV3;
  QV3.isValidHostname = FV3;
  QV3.resolveHttpHandlerRuntimeConfig = mV3;
});
