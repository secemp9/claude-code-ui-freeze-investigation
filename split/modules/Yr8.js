...
var Yr8 = v(Sp5 => {
  ...
  class Ar8 {
    ...
    constructor({
      name: A,
      kind: K = Cp5.FieldPosition.HEADER,
      values: q = []
    }) {
  ...
  class F81 {
    ...
    static clone(A) {
      ...
      if (K.query) K.query = yp5(K.query);
      return K;
    }
    static isInstance(A) {
      if (!A) return !1;
  ...
  Sp5.Fields = Kr8;
  Sp5.HttpRequest = F81;
  Sp5.HttpResponse = qr8;
  Sp5.getHttpHandlerExtensionConfiguration = Lp5;
  Sp5.isValidHostname = Ip5;
  Sp5.resolveHttpHandlerRuntimeConfig = Rp5;
});
