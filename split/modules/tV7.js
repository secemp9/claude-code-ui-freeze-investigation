...
var tV7 = v(cSY => {
  ...
  class oV7 {
    ...
    constructor({
      name: A,
      kind: K = FSY.FieldPosition.HEADER,
      values: q = []
    }) {
  ...
  class ZG1 {
    ...
    static clone(A) {
      ...
      if (K.query) K.query = pSY(K.query);
      return K;
    }
    static isInstance(A) {
      if (!A) return !1;
  ...
  cSY.Fields = aV7;
  cSY.HttpRequest = ZG1;
  cSY.HttpResponse = sV7;
  cSY.getHttpHandlerExtensionConfiguration = QSY;
  cSY.isValidHostname = dSY;
  cSY.resolveHttpHandlerRuntimeConfig = USY;
});
