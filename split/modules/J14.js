...
var J14 = v(pM3 => {
  ...
  class z14 {
    ...
    constructor({
      name: A,
      kind: K = mM3.FieldPosition.HEADER,
      values: q = []
    }) {
  ...
  class r41 {
    ...
    static clone(A) {
      ...
      if (K.query) K.query = QM3(K.query);
      return K;
    }
    static isInstance(A) {
      if (!A) return !1;
  ...
  pM3.Fields = w14;
  pM3.HttpRequest = r41;
  pM3.HttpResponse = H14;
  pM3.getHttpHandlerExtensionConfiguration = gM3;
  pM3.isValidHostname = UM3;
  pM3.resolveHttpHandlerRuntimeConfig = FM3;
});
