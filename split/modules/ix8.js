...
var ix8 = v(iO5 => {
  ...
  class dx8 {
    ...
    constructor({
      name: A,
      kind: K = UO5.FieldPosition.HEADER,
      values: q = []
    }) {
  ...
  class A61 {
    ...
    static clone(A) {
      ...
      if (K.query) K.query = cO5(K.query);
      return K;
    }
    static isInstance(A) {
      if (!A) return !1;
  ...
  iO5.Fields = cx8;
  iO5.HttpRequest = A61;
  iO5.HttpResponse = lx8;
  iO5.getHttpHandlerExtensionConfiguration = pO5;
  iO5.isValidHostname = lO5;
  iO5.resolveHttpHandlerRuntimeConfig = dO5;
});
