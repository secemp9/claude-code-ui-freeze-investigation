...
var gs8 = v(Er5 => {
  ...
  class A41 {
    ...
    static clone(A) {
      ...
      if (K.query) K.query = Tr5(K.query);
      return K;
    }
    static isInstance(A) {
      if (!A) return !1;
  ...
  Er5.Fields = Bs8;
  Er5.HttpRequest = A41;
  Er5.HttpResponse = ms8;
  Er5.getHttpHandlerExtensionConfiguration = fr5;
  Er5.isValidHostname = vr5;
  Er5.resolveHttpHandlerRuntimeConfig = Nr5;
});
