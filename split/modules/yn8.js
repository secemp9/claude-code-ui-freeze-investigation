...
var yn8 = v(yQ5 => {
  ...
  class Cn8 {
    ...
    constructor({
      name: A,
      kind: K = EQ5.FieldPosition.HEADER,
      values: q = []
    }) {
  ...
  class T81 {
    ...
    static clone(A) {
      ...
      if (K.query) K.query = LQ5(K.query);
      return K;
    }
    static isInstance(A) {
      if (!A) return !1;
  ...
  yQ5.Fields = Ln8;
  yQ5.HttpRequest = T81;
  yQ5.HttpResponse = Rn8;
  yQ5.getHttpHandlerExtensionConfiguration = kQ5;
  yQ5.isValidHostname = RQ5;
  yQ5.resolveHttpHandlerRuntimeConfig = CQ5;
});
