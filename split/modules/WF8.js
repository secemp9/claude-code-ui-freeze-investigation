...
var WF8 = v(GP5 => {
  ...
  class _F8 {
    ...
    constructor({
      name: A,
      kind: K = JP5.FieldPosition.HEADER,
      values: q = []
    }) {
  ...
  GP5.Fields = GF8;
  GP5.HttpRequest = I61;
  GP5.HttpResponse = ZF8;
  GP5.getHttpHandlerExtensionConfiguration = OP5;
  GP5.isValidHostname = _P5;
  GP5.resolveHttpHandlerRuntimeConfig = XP5;
});
