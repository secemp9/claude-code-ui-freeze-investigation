...
var n84 = v(cv3 => {
  ...
  class c84 {
    ...
    constructor({
      name: A,
      kind: K = Fv3.FieldPosition.HEADER,
      values: q = []
    }) {
  ...
  class q71 {
    ...
    static clone(A) {
      ...
      if (K.query) K.query = pv3(K.query);
      return K;
    }
    static isInstance(A) {
      if (!A) return !1;
  ...
  cv3.Fields = l84;
  cv3.HttpRequest = q71;
  cv3.HttpResponse = i84;
  cv3.getHttpHandlerExtensionConfiguration = Qv3;
  cv3.isValidHostname = dv3;
  cv3.resolveHttpHandlerRuntimeConfig = Uv3;
});
