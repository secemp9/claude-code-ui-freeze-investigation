...
var W$8 = v((ULz, Z$8) => {
  ...
  function ONq(A) {
    let K = A.COMMENT("--", "$"),
      ...
      J = ["add", "asc", "collation", "desc", "final", "first", "last", "view"],
      ...
      X = ["abs", "acos", "array_agg", "asin", "atan", "avg", "cast", "ceil", "ceiling", "coalesce", "corr", "cos", "cosh", "count", "covar_pop", "covar_samp", "cume_dist", "dense_rank", "deref", "element", "exp", "extract", "first_value", "floor", "json_array", "json_arrayagg", "json_exists", "json_object", "json_objectagg", "json_query", "json_table", "json_table_primitive", "json_value", "lag", "last_value", "lead", "listagg", "ln", "log", "log10", "lower", "max", "min", "mod", "nth_value", "ntile", "nullif", "percent_rank", "percentile_cont", "percentile_disc", "position", "position_regex", "power", "rank", "regr_avgx", "regr_avgy", "regr_count", "regr_intercept", "regr_r2", "regr_slope", "regr_sxx", "regr_sxy", "regr_syy", "row_number", "sin", "sinh", "sqrt", "stddev_pop", "stddev_samp", "substring", "substring_regex", "sum", "tan", "tanh", "translate", "translate_regex", "treat", "trim", "trim_array", "unnest", "upper", "value_of", "var_pop", "var_samp", "width_bucket"],
    ...
    function M(P, {
      ...
      let T = N;
      return f = f || [], P.map(C => {
        if (C.match(/\|\d+$/) || f.includes(C)) return C;else if (T(C)) return `${C}|0`;else return C;
      });
    }
    return {
      name: "SQL",
      ...
      contains: [{
        ...
        className: "type",
        begin: jx1(...w)
      }, j, W, q, Y, A.C_NUMBER_MODE, A.C_BLOCK_COMMENT_MODE, K, D]
    };
  }
  Z$8.exports = ONq;
});
