...
var Bd8 = v(TS5 => {
  ...
  class bd8 {
    ...
    constructor({
      name: A,
      kind: K = MS5.FieldPosition.HEADER,
      values: q = []
    }) {
  ...
  class O81 {
    ...
    static clone(A) {
      ...
      if (K.query) K.query = fS5(K.query);
      return K;
    }
    static isInstance(A) {
      if (!A) return !1;
  ...
  TS5.Fields = xd8;
  TS5.HttpRequest = O81;
  TS5.HttpResponse = ud8;
  TS5.getHttpHandlerExtensionConfiguration = PS5;
  TS5.isValidHostname = NS5;
  TS5.resolveHttpHandlerRuntimeConfig = VS5;
});
