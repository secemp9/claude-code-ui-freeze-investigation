...
var LU8 = v(UE5 => {
  ...
  class EU8 {
    ...
    constructor({
      name: A,
      kind: K = BE5.FieldPosition.HEADER,
      values: q = []
    }) {
  ...
  class s61 {
    ...
    static clone(A) {
      ...
      if (K.query) K.query = FE5(K.query);
      return K;
    }
    static isInstance(A) {
      if (!A) return !1;
  ...
  UE5.Fields = kU8;
  UE5.HttpRequest = s61;
  UE5.HttpResponse = CU8;
  UE5.getHttpHandlerExtensionConfiguration = mE5;
  UE5.isValidHostname = QE5;
  UE5.resolveHttpHandlerRuntimeConfig = gE5;
});
