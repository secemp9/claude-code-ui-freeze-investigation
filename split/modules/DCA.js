...
var DCA = v(oX5 => {
  ...
  class Pu8 {
    ...
    constructor({
      name: A,
      kind: K = cX5.FieldPosition.HEADER,
      values: q = []
    }) {
  ...
  class z61 {
    ...
    static clone(A) {
      ...
      if (K.query) K.query = nX5(K.query);
      return K;
    }
    static isInstance(A) {
      if (!A) return !1;
  ...
  oX5.Fields = Vu8;
  oX5.HttpRequest = z61;
  oX5.HttpResponse = fu8;
  oX5.getHttpHandlerExtensionConfiguration = lX5;
  oX5.isValidHostname = rX5;
  oX5.resolveHttpHandlerRuntimeConfig = iX5;
});
