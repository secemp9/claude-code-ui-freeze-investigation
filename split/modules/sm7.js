...
var sm7 = v((mgA, dv6) => {
  (function (A, K) {
    ...
    if (typeof define === "function" && define.amd) define([], function () {
      var Y = {};
      return K(Y), q(Y);
    });else if (typeof mgA === "object") {
      if (K(mgA), typeof dv6 === "object") dv6.exports = q(mgA);
    } else (function () {
      var Y = {};
      K(Y), A.Long = q(Y);
    })();
  })(typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : mgA, function (A) {
    ...
    function _(Q, u, d) {
      ...
      if (typeof u === "number") d = u, u = !1;else u = !!u;
      if (Q === "NaN" || Q === "Infinity" || Q === "+Infinity" || Q === "-Infinity") return u ? N : f;
      if (d = d || 10, d < 2 || 36 < d) throw RangeError("radix");
      var r;
      if ((r = Q.indexOf("-")) > 0) throw Error("interior hyphen");else if (r === 0) return _(Q.substring(1), u, d).neg();
      var c = O($(d, 8)),
        YA = f;
    ...
    if (b.toInt = function () {
      ...
      if (this.isNegative()) if (this.eq(B)) {
        var d = O(u),
          r = this.div(d),
          c = r.mul(d).sub(this);
      ...
      while (!0) {
        var HA = e.div(YA),
          ...
          a = _A.toString(u);
        if (e = HA, e.isZero()) return a + qA;else {
      ...
      if (!Y(u)) u = G(u);
      if (this.unsigned !== u.unsigned && this.high >>> 31 === 1 && u.high >>> 31 === 1) return !1;
      return this.high === u.high && this.low === u.low;
    }, b.eq = b.equals, b.notEquals = function (u) {
      return !this.eq(u);
    }, b.neq = b.notEquals, b.ne = b.notEquals, b.lessThan = function (u) {
      return this.comp(u) < 0;
    }, b.lt = b.lessThan, b.lessThanOrEqual = function (u) {
      return this.comp(u) <= 0;
    }, b.lte = b.lessThanOrEqual, b.le = b.lessThanOrEqual, b.greaterThan = function (u) {
      return this.comp(u) > 0;
    }, b.gt = b.greaterThan, b.greaterThanOrEqual = function (u) {
      return this.comp(u) >= 0;
    }, b.gte = b.greaterThanOrEqual, b.ge = b.greaterThanOrEqual, b.compare = function (u) {
      if (!Y(u)) u = G(u);
      ...
      return u.high >>> 0 > this.high >>> 0 || u.high === this.high && u.low >>> 0 > this.low >>> 0 ? -1 : 1;
    }, b.comp = b.compare, b.negate = function () {
      if (!this.unsigned && this.eq(B)) return B;
      return this.not().add(T);
    }, b.neg = b.negate, b.add = function (u) {
      if (!Y(u)) u = G(u);
      var d = this.high >>> 16,
        r = this.high & 65535,
        c = this.low >>> 16,
        ...
        jA = 0,
        MA = 0;
      return MA += YA + _A, jA += MA >>> 16, MA &= 65535, jA += c + HA, JA += jA >>> 16, jA &= 65535, JA += r + qA, a += JA >>> 16, JA &= 65535, a += d + e, a &= 65535, X(jA << 16 | MA, a << 16 | JA, this.unsigned);
    }, b.subtract = function (u) {
      if (!Y(u)) u = G(u);
      return this.add(u.neg());
    }, b.sub = b.subtract, b.multiply = function (u) {
      ...
      if (this.isNegative()) {
        if (u.isNegative()) return this.neg().mul(u.neg());else return this.neg().mul(u).neg();
      } else if (u.isNegative()) return this.mul(u.neg()).neg();
      if (this.lt(P) && u.lt(P)) return O(this.toNumber() * u.toNumber(), this.unsigned);
      var r = this.high >>> 16,
        c = this.high & 65535,
        YA = this.low >>> 16,
        e = this.low & 65535,
        ...
        MA = 0,
        hA = 0;
      return hA += e * a, MA += hA >>> 16, hA &= 65535, MA += YA * a, jA += MA >>> 16, MA &= 65535, MA += e * _A, jA += MA >>> 16, MA &= 65535, jA += c * a, JA += jA >>> 16, jA &= 65535, jA += YA * _A, JA += jA >>> 16, jA &= 65535, jA += e * HA, JA += jA >>> 16, jA &= 65535, JA += r * a + c * _A + YA * HA + e * qA, JA &= 65535, X(MA << 16 | hA, JA << 16 | jA, this.unsigned);
    }, b.mul = b.multiply, b.divide = function (u) {
      if (!Y(u)) u = G(u);
      if (u.isZero()) throw Error("division by zero");
      if (K) {
        if (!this.unsigned && this.high === -2147483648 && u.low === -1 && u.high === -1) return this;
        var d = (this.unsigned ? K.div_u : K.div_s)(this.low, this.high, u.low, u.high);
        return X(d, K.get_high(), this.unsigned);
      }
      ...
      if (!this.unsigned) {
        if (this.eq(B)) {
          if (u.eq(T) || u.eq(R)) return B;else if (u.eq(B)) return T;else {
            var e = this.shr(1);
            if (r = e.div(u).shl(1), r.eq(f)) return u.isNegative() ? T : R;else return c = this.sub(u.mul(r)), YA = r.add(c.div(u)), YA;
          }
      ...
      while (c.gte(u)) {
        ...
        var qA = Math.ceil(Math.log(r) / Math.LN2),
          ...
          _A = O(r),
          a = _A.mul(u);
        while (a.isNegative() || a.gt(c)) r -= HA, _A = O(r, this.unsigned), a = _A.mul(u);
        if (_A.isZero()) _A = T;
        YA = YA.add(_A), c = c.sub(a);
      }
      return YA;
    }, b.div = b.divide, b.modulo = function (u) {
      if (!Y(u)) u = G(u);
      if (K) {
        var d = (this.unsigned ? K.rem_u : K.rem_s)(this.low, this.high, u.low, u.high);
        return X(d, K.get_high(), this.unsigned);
      }
    ...
    }, b.ctz = b.countTrailingZeros, b.and = function (u) {
      if (!Y(u)) u = G(u);
      ...
      if (Y(u)) u = u.toInt();
      if ((u &= 63) === 0) return this;else if (u < 32) return X(this.low << u, this.high << u | this.low >>> 32 - u, this.unsigned);else return X(0, this.low << u - 32, this.unsigned);
    }, b.shl = b.shiftLeft, b.shiftRight = function (u) {
      if (Y(u)) u = u.toInt();
      if ((u &= 63) === 0) return this;else if (u < 32) return X(this.low >>> u | this.high << 32 - u, this.high >> u, this.unsigned);else return X(this.high >> u - 32, this.high >= 0 ? 0 : -1, this.unsigned);
    }, b.shr = b.shiftRight, b.shiftRightUnsigned = function (u) {
      if (Y(u)) u = u.toInt();
      if ((u &= 63) === 0) return this;
      if (u < 32) return X(this.low >>> u | this.high << 32 - u, this.high >>> u, this.unsigned);
      if (u === 32) return X(this.high, 0, this.unsigned);
      return X(this.high >>> u - 32, 0, this.unsigned);
    }, b.shru = b.shiftRightUnsigned, b.shr_u = b.shiftRightUnsigned, b.rotateLeft = function (u) {
      var d;
      if (Y(u)) u = u.toInt();
      if ((u &= 63) === 0) return this;
      if (u === 32) return X(this.high, this.low, this.unsigned);
      if (u < 32) return d = 32 - u, X(this.low << u | this.high >>> d, this.high << u | this.low >>> d, this.unsigned);
      return u -= 32, d = 32 - u, X(this.high << u | this.low >>> d, this.low << u | this.high >>> d, this.unsigned);
    }, b.rotl = b.rotateLeft, b.rotateRight = function (u) {
      var d;
      if (Y(u)) u = u.toInt();
      if ((u &= 63) === 0) return this;
      if (u === 32) return X(this.high, this.low, this.unsigned);
      if (u < 32) return d = 32 - u, X(this.high << d | this.low >>> u, this.low << d | this.high >>> u, this.unsigned);
      return u -= 32, d = 32 - u, X(this.low << d | this.high >>> u, this.high << d | this.low >>> u, this.unsigned);
      ...
      var u = this.high,
        d = this.low;
      return [d & 255, d >>> 8 & 255, d >>> 16 & 255, d >>> 24, u & 255, u >>> 8 & 255, u >>> 16 & 255, u >>> 24];
    }, b.toBytesBE = function () {
      var u = this.high,
        d = this.low;
      return [u >>> 24, u >>> 16 & 255, u >>> 8 & 255, u & 255, d >>> 24, d >>> 16 & 255, d >>> 8 & 255, d & 255];
    }, q.fromBytes = function (u, d, r) {
      return r ? q.fromBytesLE(u, d) : q.fromBytesBE(u, d);
    }, q.fromBytesLE = function (u, d) {
      return new q(u[0] | u[1] << 8 | u[2] << 16 | u[3] << 24, u[4] | u[5] << 8 | u[6] << 16 | u[7] << 24, d);
    }, q.fromBytesBE = function (u, d) {
      return new q(u[4] << 24 | u[5] << 16 | u[6] << 8 | u[7], u[0] << 24 | u[1] << 16 | u[2] << 8 | u[3], d);
    }, typeof BigInt === "function") q.fromBigInt = function (u, d) {
      var r = Number(BigInt.asIntN(32, u)),
        c = Number(BigInt.asIntN(32, u >> BigInt(32)));
      return X(r, c, d);
    }, q.fromValue = function (u, d) {
      if (typeof u === "bigint") return q.fromBigInt(u, d);
      return G(u, d);
    }, b.toBigInt = function () {
